...
class BoxesControllerTest < ActionController::TestCase
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post :create, box: { color: @box.color, description: @box.description, done: @box.done, name: @box.name, pos_x: @box.pos_x, pos_y: @box.pos_y, start_date: @box.start_date }
    end
  ...
  test "should update box" do
    patch :update, id: @box, box: { color: @box.color, description: @box.description, done: @box.done, name: @box.name, pos_x: @box.pos_x, pos_y: @box.pos_y, start_date: @box.start_date }
    assert_redirected_to box_path(assigns(:box))
  end
